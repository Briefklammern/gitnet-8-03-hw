# Домашнее задание к занятию "Git" - Сафронов П.А.
...
![Создание gitignore и его статус](https://github.com/Briefklammern/gitnet-8-03-hw/blob/main/img/2.1.PNG)

2. Добавьте файл .gitignore в следующий коммит git add....

![git add](https://github.com/Briefklammern/gitnet-8-03-hw/blob/main/img/2.2.PNG)
...
![Создал ветку и test.sh](https://github.com/Briefklammern/gitnet-8-03-hw/blob/main/img/3.1-3.2.PNG)

3. Сделайте несколько коммитов и пушей в ветку dev, имитируя активную работу над файлом в процессе разработки.

![Несколько коммитов в test.sh](https://github.com/Briefklammern/gitnet-8-03-hw/blob/main/img/3.3.PNG)

4. Переключитесь на основную ветку.
5. Добавьте файл main.sh в основной ветке с произвольным содержимым, сделайте комит и пуш . Так имитируется продолжение общекомандной разработки в основной ветке во время разработки отдельного функционала в dev ветке.

![Задания 4-5](https://github.com/Briefklammern/gitnet-8-03-hw/blob/main/img/3.3-3.5.PNG)
